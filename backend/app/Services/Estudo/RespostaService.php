...
use App\Models\Estudo\Resposta;
...
class RespostaService
{
    ...
    public function store($request)
    {
        ...
        DB::beginTransaction();
        try {
            $data = $this->resposta->create($dataFrom);
            DB::commit();
