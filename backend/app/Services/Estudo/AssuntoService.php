...
class AssuntoService
{
    ...
    public function store($request)
    {
        ...
        DB::beginTransaction();
        try {
            $data = $this->assunto->create($dataFrom);
            DB::commit();
